                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body p-0">
                                    <ul class="px-1">
                                        <li>
                                            <a href="admin_reviews.php" class="active"> <i class="fas fa-star"></i>
                                                Reviews</a>
                                        </li>
                                        <li>
                        ...
                        <tbody>
                            <?php
                                    ...
                                    while($row = $stmt->fetch()){
                                        if($row["Score"] == 5){
                                            $store_rating = "<i class=\"fas fa-star text-warning\"> </i><i class=\"fas fa-star text-warning\"> </i><i class=\"fas fa-star text-warning\"> </i><i class=\"fas fa-star text-warning\"> </i><i class=\"fas fa-star text-warning\"> </i>";
                                        }else if($row["Score"] == 4){
                                            $store_rating = "<i class=\"fas fa-star text-warning\"> </i><i class=\"fas fa-star text-warning\"> </i><i class=\"fas fa-star text-warning\"> </i><i class=\"fas fa-star text-warning\"> </i>";
                                        }else if($row["Score"] == 3){
                                            $store_rating = "<i class=\"fas fa-star text-warning\"> </i><i class=\"fas fa-star text-warning\"> </i><i class=\"fas fa-star text-warning\"> </i>";
                                        }else if($row["Score"] == 2){
                                            $store_rating = "<i class=\"fas fa-star text-warning\"> </i><i class=\"fas fa-star text-warning\"> </i>";
                                        }else{
                                            $store_rating = "<i class=\"fas fa-star text-warning\"> </i>";
                                        }
                                ?>
                            <tr>
                                <td><?= $row["id"] ?></td>
